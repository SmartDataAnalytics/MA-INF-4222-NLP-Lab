...
|14| -- | Neural Network based Commonsense causal reasoning | Two steps: (i) Learning latent representation of ConceptNet. Use representation to predict response for a given premise.  | 2255383-Asif Khan | -- |
....
more to come!
